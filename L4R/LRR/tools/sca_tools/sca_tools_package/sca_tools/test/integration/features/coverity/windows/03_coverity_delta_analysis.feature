...
Feature: Delta analysis
  ...
  Scenario Outline: Report is created
    ...
    And a json config for <config_key>
      ...
      | COVERITY_PROJECT_PATH               | %(test_root)s/test/integration/bin/%(config_key)s_delta                                   |
      | EXPORT_FORMATS                      | csv                                                                                       |
