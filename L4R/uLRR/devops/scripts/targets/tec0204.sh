...
declare -A TARGET_SETTINGS=(
    ["PATH_DTG_ST"]="xilinx_artifacts/device-tree-xlnx/device-tree-xlnx-xlnx_rel_v2021.2.zip"
    ["PATH_DTG"]="$1/device-tree-xlnx-xlnx_rel_v2021.2.zip"
    ["PATH_XSA_FILE"]="/ws/software/os/debian/hw/tec0204/radl4_tec0204.xsa"
    ["PATH_U_BOOT_ST"]="xilinx_artifacts/u-boot-xlnx/u-boot-xlnx-xilinx-v2021.2.zip"
    ["PATH_U_BOOT"]="$1/u-boot-xlnx-xilinx-v2021.2.zip"
    ["PATH_BITSTREAM"]="/ws/software/os/debian/components/hw/build/build_tec0204/xsa/radl4_tec0204.bit"
