...
Feature: CONFIG
  ...
  Scenario: Generates configuration for combinations of qac versions with synctypes with different compilers with minimal base configuration options
    ...
    And these options for config generation
      ...
      | QAC_BIN_PATH    | C:/TCC/Tools/helix_qac/%(qac_version_min)s_WIN64/common/bin                         |
    ...
    Then configurations are generated for those compilers
      | qac_version | compiler | cct                                             | compile_target |
      | helix2020.1 | msvc     | [MS_VS_2015_x64_C++.cct,MS_VS_2015_x64_C.cct]   | msvc14         |
      | helix2020.2 | msvc     | [MS_VS_2015_x64_C++.cct,MS_VS_2015_x64_C.cct]   | msvc14         |
      | helix2021.1 | msvc     | [MS_VS_2015_x64_C++.cct,MS_VS_2015_x64_C.cct]   | msvc14         |
      | helix2021.2 | msvc     | [MS_VS_2015_x64_C++.cct,MS_VS_2015_x64_C.cct]   | msvc14         |
      | helix2021.3 | msvc     | [MS_VS_2015_x64_C++.cct,MS_VS_2015_x64_C.cct]   | msvc14         |
