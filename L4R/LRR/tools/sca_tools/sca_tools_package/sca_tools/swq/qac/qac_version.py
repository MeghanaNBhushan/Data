...
_REGEX_FOR_FULL_VERSION_LINE = (
    r'(?P<name>PRQA\sFramework|Helix\sQAC)(\sversion)?'    # PRQA / QAC string
...
class QacVersion:
    ...
    def _get_software_name_and_version(self):
        ...
        LOGGER.warning('Unknown software version = %s',
    ...
    def major_minor(self):
        ...
        LOGGER.warning('Unknown major and minor. version = %s',
                       self._software_version)
        return (0, 0)

    def is_helix(self):
        """Returns wether the running software is helix"""
        return 'QAC' in self._software_name
