...
#  if __GLIBCXX__ == 20210408

// clang 12.0.0/gcc-10.3.0

#    define __PRL_GLIBCXX__            10
#    define __PRL_GLIBCXX_MINOR__      3
#    define __PRL_GLIBCXX_PATCHLEVEL__ 0



#  elif __GLIBCXX__ == 20181206
...
#  error "This version of the libstdc++ headers, defined by __GLIBCXX__, is not supported or has been modified in this distribution.  Please contact support at http://www.programmingresearch.com/services/contact-support."
...
#elif ( __PRL_GLIBCXX__ > 9 )  && (__QACPP_MAJOR__ < 47)

#  error "This version of the libstdc++ headers(" __GLIBC_CXX__ ") requires QA C++ version 4.7 or later.   Please contact support at http://www.programmingresearch.com/services/contact-support."
