...
#define __is_same_as(x,y)                         __qacpp_is_same(x,y)
...
#define __is_trivially_constructible              __qacpp_is_trivially_constructible
...
// we don't have a distinct __float128 type
#define __HAVE_FLOAT128 0
#define __HAVE_FLOAT128 _ignore_modification
